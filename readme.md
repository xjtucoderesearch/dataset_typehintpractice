This repository illustrates the data used for the study, and the data is generated by the tool named [THProfiler](https://github.com/TypingPractice/THProfiler).
# Study Setup 
